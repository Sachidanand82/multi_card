...
const Card = () => {
  ...
  const scratchImages = [
    { foreground: require('./assets/scratch_foreground.png'), background: require('./assets/better.jpg') },
    { foreground: require('./assets/scratch_foreground.png'), background: require('./assets/better.jpg') },
    { foreground: require('./assets/scratch_foreground.png'), background: require('./assets/better.jpg') },
    { foreground: require('./assets/scratch_foreground.png'), background: require('./assets/50.jpg') },
    { foreground: require('./assets/scratch_foreground.png'), background: require('./assets/better.jpg') },
    { foreground: require('./assets/scratch_foreground.png'), background: require('./assets/better.jpg') },
  ];
